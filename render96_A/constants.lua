-- Acts
ACT_JUMP_NO_CONTROL_HEIGHT      = allocate_mario_action(ACT_JUMP & ~ACT_FLAG_CONTROL_JUMP_HEIGHT)
...
ACT_BANANAMAN_JUMP              = allocate_mario_action(ACT_GROUP_AIRBORNE |ACT_FLAG_AIR | ACT_FLAG_ATTACKING | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION | ACT_FLAG_MOVING)
