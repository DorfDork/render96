Lights1 yellow_coin_low_poly_coin_yellow_side_lights = gdSPDefLights1(
	0x1F, 0x14, 0x4,
	0x47, 0x32, 0x11, 0x28, 0x28, 0x28);

Lights1 yellow_coin_low_poly_f3dlite_material_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFF, 0xFF, 0xFF, 0x28, 0x28, 0x28);

Texture yellow_coin_low_poly_coin_side_rgba32[] = {
	#include "completed blends/yellow_coin_low_poly/coin_side.rgba32.inc.c"
};

Texture yellow_coin_low_poly_yellow_coin_lod_rgba32[] = {
	#include "completed blends/yellow_coin_low_poly/yellow_coin_lod.rgba32.inc.c"
};

Vtx yellow_coin_low_poly_000_displaylist_mesh_layer_4_vtx_0[16] = {
...
Gfx yellow_coin_low_poly_000_displaylist_mesh_layer_4_tri_0[] = {
	gsSPVertex(yellow_coin_low_poly_000_displaylist_mesh_layer_4_vtx_0 + 0, 16, 0),
...
Vtx yellow_coin_low_poly_000_displaylist_mesh_layer_1_vtx_0[16] = {
...
Gfx yellow_coin_low_poly_000_displaylist_mesh_layer_1_tri_0[] = {
	gsSPVertex(yellow_coin_low_poly_000_displaylist_mesh_layer_1_vtx_0 + 0, 16, 0),
...
Gfx mat_yellow_coin_low_poly_coin_yellow_side[] = {
	gsSPSetGeometryMode(G_TEXTURE_GEN),
	gsSPSetLights1(yellow_coin_low_poly_coin_yellow_side_lights),
	gsDPPipeSync(),
	...
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_32b_LOAD_BLOCK, 1, yellow_coin_low_poly_coin_side_rgba32),
...
Gfx mat_revert_yellow_coin_low_poly_coin_yellow_side[] = {
...
Gfx mat_yellow_coin_low_poly_f3dlite_material[] = {
	gsSPSetLights1(yellow_coin_low_poly_f3dlite_material_lights),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
	gsDPSetAlphaDither(G_AD_NOISE),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_32b_LOAD_BLOCK, 1, yellow_coin_low_poly_yellow_coin_lod_rgba32),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_32b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
...
Gfx mat_revert_yellow_coin_low_poly_f3dlite_material[] = {
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsSPEndDisplayList(),
};

Gfx yellow_coin_low_poly_000_displaylist_mesh_layer_4[] = {
	gsSPDisplayList(mat_yellow_coin_low_poly_coin_yellow_side),
	gsSPDisplayList(yellow_coin_low_poly_000_displaylist_mesh_layer_4_tri_0),
	gsSPDisplayList(mat_revert_yellow_coin_low_poly_coin_yellow_side),
	gsDPPipeSync(),
...
Gfx yellow_coin_low_poly_000_displaylist_mesh_layer_1[] = {
	gsSPDisplayList(mat_yellow_coin_low_poly_f3dlite_material),
	gsSPDisplayList(yellow_coin_low_poly_000_displaylist_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_yellow_coin_low_poly_f3dlite_material),
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_LIGHTING),
	gsSPClearGeometryMode(G_TEXTURE_GEN),
	gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT, 0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT),
